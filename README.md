...
You can then execute your native executable with: `./target/fgl_soap_skeleton-1.0.0-SNAPSHOT-runner`
...
- Quarkus CXF ([guide](https://quarkiverse.github.io/quarkiverse-docs/quarkus-cxf/dev/index.html)): Consume and produce SOAP web services with Apache CXF
